...
(function () {
  ...
  var NAV = [
    ...
    { id: 'flow-checker',         href: 'elements-of-flow.html',                  icon: 'checklist',        label: 'Elements of Flow',     group: 'Create' },
    ...
    { id: 'cue-worksheet',        href: 'verb-your-body-part-direction.html',                 icon: 'edit_note',    label: 'Verb / Your Body Part / Direction', group: 'Practice' },
