...
(function () {
  ...
  var NAV = [
    ...
    { id: 'cue-worksheet',        href: 'verb-your-body-part-direction.html',                 icon: 'edit_note',    label: 'Verb / Your Body Part / Direction', group: 'Create' },
    { id: 'class-writer',         href: 'class-writer.html',                  icon: 'edit_document',    label: 'Class Writer',         group: 'Create' },
    { id: 'movement-experiments', href: 'movement-experiments.html', icon: 'gesture',      label: 'Movement Experiments', group: 'Practice' },
    { id: 'arbitrary-rules',      href: 'arbitrary-rules.html',      icon: 'casino',       label: 'Arbitrary Rules',      group: 'Practice' },
    { id: 'breath-pacer',         href: 'breath-pace.html',           icon: 'air',          label: 'Breath Pace',          group: 'Practice' },
    { id: 'pose-connector',       href: 'pose-popcorn.html',                  icon: 'conversion_path',        label: 'Pose Popcorn',         group: 'Practice' },
    { id: 'story-starters',       href: 'story-starters.html',                icon: 'auto_stories',     label: 'Story Starters',       group: 'Practice' },
    { id: 'shorthand-library',    href: 'shorthand-library.html',             icon: 'book',             label: 'Shorthand Library',    group: 'Resources' },
    { id: 'flow-checker',         href: 'elements-of-flow.html',                  icon: 'checklist',        label: 'Elements of Flow',     group: 'Resources' },
    { id: 'your-stories',         href: 'stories.html',                       icon: 'library_books',    label: 'Your Stories',         group: 'Resources' },
  ];
  ...
  var PAGE_IDS = {
    ...
    'class-writer.html':                  'class-writer',
    'saved.html':                         'saved',
  };
